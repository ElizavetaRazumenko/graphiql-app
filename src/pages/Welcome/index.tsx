  ...
  return (
    <WelcomeWrapper>
      ...
      <PersonCard>
        ...
        <PersonInfo>
          <PersonName>Elizaveta Razumenko</PersonName>
          <PersonDescription>
            ...
            I&nbsp;am inspired by&nbsp;what I&nbsp;do. And I&nbsp;hope this
            hobby will become the main occupation of&nbsp;my&nbsp;life
          </PersonDescription>
        </PersonInfo>
      </PersonCard>
      <PersonCard>
        ...
        <PersonInfo>
          <PersonName>Vitali Piadus</PersonName>
          <PersonDescription>
      ...
      <PersonCard>
        ...
        <PersonInfo>
          <PersonName>Alexei Shmulevtsov</PersonName>
          <PersonDescription>
            I&nbsp;graduated from the Minsk College of&nbsp;Business
            in&nbsp;Minsk, I&nbsp;have been doing programming for more than
            a&nbsp;year, I&nbsp;like different sports and a&nbsp;lot
            of&nbsp;tea. I&rsquo;m not sitting still, trying to&nbsp;get into
            the&nbsp;IT. I&nbsp;hope to&nbsp;become a&nbsp;first-class developer
            and a&nbsp;good person in&nbsp;the near future!
          </PersonDescription>
        </PersonInfo>
      </PersonCard>
    </WelcomeWrapper>
